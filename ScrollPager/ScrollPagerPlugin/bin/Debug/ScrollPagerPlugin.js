...
if($p2_0<$1_1*$1.pageSize&&$p2_0>=($1_1-1)*$1.pageSize){$(this).addClass('page'+$1_1);}else{$(this).addClass('page'+($1_1+1));$1_1++;}});var $1_5=$($1.container).height();var $1_6=$1_5;$1_0.children().hide();$('.page'+$1.currentPage).show();if($1_1>1){$1_6=($1_5/$1_1);var $1_12="<UL class=scrollbar sizcache='4' sizset='13'>";for($p1_0=1;$p1_0<=$1_1;$p1_0++){if($p1_0===$1.currentPage){$1_12+="<LI class='currentPage pageItem' sizcache='4' sizset='13'><A class='sliderPage' href='#' rel='"+$p1_0+"'></A>";}else{$1_12+="<LI class='pageNav"+$p1_0+" pageItem' sizcache='4' sizset='14'><A class='sliderPage' href='#' rel='"+$p1_0+"'></A>";}}var $1_13=Math.round(($1.currentPage-1)*$1_6);var $1_14=Math.round(($1_6-3));var $1_15="<LI class='thumb' style='top:"+$1_13+'; height:'+$1_14+"px;'><div class='sliderThumb'><A class='sliderThumb' href='#' rel='"+$p1_0+"'>"+$1.currentPage+'</A></div>';$1_12+=$1_15;$1_12+='</LI></UL>';if(!$1.holder){$1_0.after($1_12);}else{$($1.holder).append($1_12);}$('.pageItem').height($1_6);}var $1_7=$('.scrollbar');var $1_8=$('.thumb');var $1_9=($1_7.height()-$1_8.height());var $1_A=$('.pageItem a');var $1_B=function($p2_0){
...
$(document).unbind('mousemove',$1_E);$(document).unbind('mouseup',$1_F);$1_8.die('mouseup',$1_F);$1_B($($1_A[$1_4]));$1_8.text($1_4.toString());};var $1_10=function($p2_0){
